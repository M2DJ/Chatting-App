...
const SignUpPage = () => {
  ...
  */
  ...
  if (width <= 450) {
        ...
        <div className="h-full flex justify-center items-center">
          ...
          */}
            <form className="mb-3" onSubmit={handleFormSubmition}>
              ...
              <div className="flex justify-center">
                <button className="cursor-pointer flex justify-center items-center py-2 w-full text-[clamp(1.5em,2vw,2.5em)] text-text-light dark:text-text-dark sm:max-w-[50%] md:max-w-[60%] lg:max-w-[60%] border border-black/50 dark:border-white/50 rounded-md bg-auth-light dark:bg-auth-dark">
                  {isLoading ? (
          ...
          */}
            <div className="flex justify-around items-center mb-5">
              ...
              <p className="text-[clamp(16px,1.5vw,90px)] text-text-light dark:text-text-dark">
                OR
              </p>
    ...
    return (
      <div className="h-screen bg-bg-auth-light dark:bg-auth-dark">
        <div className="h-full flex justify-center items-center">
          <div
          ...
          */}
            <form className="mb-3" onSubmit={handleFormSubmition}>
              ...
              <input
                onChange={(e) => setEmail(e.target.value)}
                className="h-[4vh] min-h-10 max-h-80 w-full border text-[clamp(16px,1.25vw,80px)] border-black/55 bg-input-light rounded-xl pl-2 mb-1"
              />
              <label className="text-[clamp(16px,1.5vw,90px)] text-text-light dark:text-text-dark">
                Password
              </label>
